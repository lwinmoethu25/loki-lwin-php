...
<div class="header bg-gradient-primary">
    <div class="container">
        <div class="table-responsive">
            <div>
                <table class="table align-items-center table-dark mt-8">
                        ...
                        <tr>
                            <th scope="row">
                                <div class="media align-items-center">
                                    <a href="#" class="avatar rounded-circle mr-3">
                                        ...
                                        <img alt="Image placeholder" src="{{ $item->attributes->image }}">
                            ...
                            <td>
                                <span class="badge badge-dot mr-4">
                                    ...
                                    <span class="status">RM {{$item->price * $item -> quantity}}</span>
                                </span>
                            </td>
                            <td>
